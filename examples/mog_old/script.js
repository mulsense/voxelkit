...
// miku.mog is a file written by the old MOG3D editor: a text tree rather than the
// current JSON. voxelkit.load() picks the loader from the content, so nothing here
// differs from the examples/mog sample.
xnew(document.querySelector('#main'), Main);

function Main(unit, { mogPath = './miku.mog', vrmaPath = './VRMA_01.vrma', size = 512 } = {}) {
  xnew.protect();
